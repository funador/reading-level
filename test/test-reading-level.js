...
describe('readingLevel', () => {
  ...
  describe('empty string', () => {
    it('should return error message on empty string', () => {
      assert.equal('Either no sentences or words, please enter some text', readingLevel(text3))
    })
  })

  describe('numeric values', () => {
    it('should return error message on string with all numeric values', () => {
      assert.equal('Either no sentences or words, please enter some text', readingLevel(text4))
    })
  })
  ...
  describe('full return values with error', () => {
    it('should return an object with all the values', () => {
      ...
      assert.equal('Either no sentences or words, please enter some text', result.error)
    })
  })
